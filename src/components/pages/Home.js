  ...
  return (
    <div className='home'>
      ...
      <div className="content">
        ...
        <p> Receive personalized suggestions, schedule with ease, and stay ahead of trends.</p>
       <p> Perfect for content creators, businesses, and talent showcasing their best.</p>
