  ...
  return (
    <div className="account-page">
      ...
      <section className="profile-section">
        ...
        <div className="profile-details">
          ...
          <div className="basic-info">
           ...
           <button className='Button' onClick={deleteBio}>Delete Bio</button>
      </section>
      ...
      <section className="about-me-section">
        ...
        <textarea value={userBio} onChange={(e) => setUserBio(e.target.value)}></textarea>
      ...
      <section className="edit-profile-section">
        ...
        <form onSubmit={saveProfile}>
          ...
          <input type="text" id="uName" value={userName} onChange={(e) => setUserName(e.target.value)} required />
          <label htmlFor="uEmail">Email:</label>
          <input type="email" id="uEmail" value={userEmail} onChange={(e) => setUserEmail(e.target.value)} required />
          <label htmlFor="userphoto">Upload Photo:</label>
          <input type="file" onChange={onFileSelected} id="userphoto" name="userphoto" />
          <button type="submit">Save</button>
        </form>
      </section>
      <div><button className='Button' onClick={logout}>Log Out</button></div>
    </div>
  );
};
